...
export default function delivery({ title, subtitle }: deliveryProps) {
  return (
    <div className="flex gap-2 md:gap-3 items-center justify-center p-2 border-solid border-gray-light border mt-10 rounded">
      <Icon icon={truckLine} className="text-5xl w-16" />
      <div>
